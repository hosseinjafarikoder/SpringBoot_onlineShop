...
<body class="body-bg">
   ...
   <main>
                           ...
                           <div class="profile-img pos-rel">
                              <div class="profile-action">
                                 <ul>
                                    ...
                                    <li><a href="login.html"><i class="fal fa-sign-out"></i>خروج</a></li>
                                 </ul>
                              </div>
            ...
            <div class="row wow fadeInUp">
               <div class="col-lg-12">
                  <div class="page-title">
                     <h2 class="breadcrumb-title mb-10">ثبت نام</h2>
                     <div class="breadcrumb-menu">
                        <nav class="breadcrumb-trail breadcrumbs">
                           <ul class="trail-items">
                              <li class="trail-item trail-begin"><a href="index.html">خانه</a>
                              </li>
                              <li class="trail-item trail-end"><span>ثبت نام</span></li>
                           </ul>
                        </nav>
                     </div>
                  </div>
      ...
      <!-- sign-up area start  -->
      <section class="sign-up-area pt-130 pb-90" data-background="${pageContext.request.contextPath}/static/security/assets/img/bg/sign-up-bg.jpg">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="sign-up-wrapper pos-rel mb-40 wow fadeInUp">
                     <div class=" sign-up-inner">
                        <div class="sign-up-content">
                           <h4>ساخت حساب کاربری</h4>
                           <p class="mb-35">ایجاد یک حساب کاربری برای توکن های غیرقابل تعویض و فروش هر کدام از آنها آسان است
                              موارد
                              به طور مستقل آنلاین و ایمن در
                              جهان</p>
                                    ...
                                    <div class="single-input-unit">
                                       ...
                                       <spring:bind path="firstName">
                                          <div class="form-group">
                                             <form:input cssStyle="color: #4fc514" id="f-name" type="text" path="firstName" class="form-control" placeholder="نام"></form:input>
                                          </div>
                                       </spring:bind>
<%--                                       <input type="text" name="f-name" id="f-name" placeholder="فعلا خالی رد میکنم">--%>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="single-input-unit">
                                       ...
                                       <spring:bind path="lastName">
                                          <div class="form-group">
                                             <form:input cssStyle="color: #4fc514" id="l-name" type="text" path="lastName" class="form-control" placeholder=" نام خانوادگی "></form:input>
                                          </div>
                                       </spring:bind>
<%--                                       <input type="text" name="l-name" id="l-name" placeholder="فعلا خالی رد میکنم">--%>
                                    </div>
                                 </div>
<%--                                 <div class="col-md-6">--%>
<%--                                    <div class="single-input-unit">--%>
<%--                                       <label for="g-select">جنسیت</label>--%>
<%--                                       <select name="g-select" id="g-select" class="gender-category-select">--%>
<%--                                          <option value="1">فعلا خالی رد میکنم</option>--%>
                              ...
                              <div class="col-md-6">
                                 <div class="single-input-unit">
                                    ...
                                    <spring:bind path="username">
                                       <div class="form-group ${status.error ? 'has-error' : ''}">
                                          <form:input cssStyle="color: #4fc514" id="u-name" type="text" path="username" class="form-control" placeholder="Username"
                                 ...
                                 <div class="col-md-6">
                                    <div class="single-input-unit">
                                       ...
                                       <spring:bind path="lastName">
                                          <div class="form-group">
                                             <form:input cssStyle="color: #4fc514" id="email" type="text" path="email" class="form-control" placeholder=" ایمیل"></form:input>
                                          </div>
                                       </spring:bind>
<%--                                       <input type="email" name="m-id" id="m-id" placeholder="فعلا خالی رد میکنم">--%>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="single-input-unit">
                                       ...
                                       <spring:bind path="password">
                                          <div class="form-group ${status.error ? 'has-error' : ''}">
                                             <form:input cssStyle="color: #4fc514" id="password" type="password" path="password" class="form-control" placeholder="Password"></form:input>
                              ...
                              <div class="col-md-6">
                                 <div class="single-input-unit">
                                    ...
                                    <spring:bind path="passwordConfirm">
                                       <div class="form-group ${status.error ? 'has-error' : ''}">
                                          <form:input cssStyle="color: #4fc514" id="password-confirm" type="password" path="passwordConfirm" class="form-control"
                                                      placeholder="Confirm your password"></form:input>
                                          <form:errors path="passwordConfirm"></form:errors>
                                       </div>
                                    </spring:bind>
<%--                                    <input type="email" name="m-id" id="password-confirm" placeholder="تکرار گذرواژه">--%>
                                 </div>
                              </div>

                              </div>
                              <div class="sign-up-btn">
                                 <button class="fill-btn" type="submit">ساخت حساب</button>
                                 <div class="note">حساب کاربری دارید؟ <a href="${pageContext.request.contextPath}/login" class="text-btn">ورود</a>
                                 </div>
                              </div>
...
<%--                           </form>--%>
                     ...
                     <div class="sign-up-with-social">
                        <div class="sign-up-with-social-bg" data-background="${pageContext.request.contextPath}/static/security/assets/img/bg/sign-up-social-bg.jpg"></div>
                        <div class="sign-up-with-social-content">
                           <div class="text-or">یا</div>
                           <div class="sign-up-media">
                              <a href="#" class="sign-up-media-single"><img src="${pageContext.request.contextPath}/static/security/assets/img/svg-icon/gmail.svg"
                                    alt="media-img"> ثبت نام با ایمیل</a>
                              <a href="#" class="sign-up-media-single"><img src="${pageContext.request.contextPath}/static/security/assets/img/svg-icon/facebook.svg"
                                    alt="media-img"> ثبت نام با فیسبوک</a>
                              <a href="#" class="sign-up-media-single"><img src="${pageContext.request.contextPath}/static/security/assets/img/svg-icon/twitter.svg"
                                    alt="media-img"> ثبت نام با تویئتر</a>
                           </div>
                        </div>
                     </div>
                  </div>
